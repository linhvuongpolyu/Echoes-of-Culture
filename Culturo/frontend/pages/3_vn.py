...
def vietnam_page():
    ...
    st.title("🇻🇳 Vietnam Knowledge Exploration")
    st.markdown("Welcome to the Vietnamese Culture Learning Platform!")
    ...
    with col1:
        ...
        st.markdown("Learn Vietnamese pronunciation")
        if st.button("Language", key="lang_vn"):
            st.session_state.current_region = "Vietnam"
            st.switch_page("pages/4_lg.py")
    
    with col2:
        st.markdown("### 🎨 Draw animals")
        st.markdown("Draw animals characteristic of Vietnam")
        if st.button("Draw Animals", key="draw_vn"):
            st.session_state.current_region = "Vietnam"
    ...
    with col3:
        ...
        if st.button("Food Culture Quiz", key="food_vn"):
            st.session_state.current_region = "Vietnam"
    ...
    with col4:
        ...
        st.markdown("Watch the video and answer questions")
        if st.button("Performance Culture Quiz", key="per_vn"):
            st.session_state.current_region = "Vietnam"
